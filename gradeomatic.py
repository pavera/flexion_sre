...
if __name__ == '__main__':
    ...
    parser.add_argument('orig_temp', type=float, nargs=1,
    ...
    parser.add_argument('student_answer', type=float, nargs=1)

    args = parser.parse_args()
    tc = TempConverter()
    tc.run_conversion(args.orig_temp[0], args.orig_scale[0], args.dest_scale[0], args.student_answer[0])
